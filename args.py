...
def parse_args():
    ...
    parser.add_argument('--attr_embedding', nargs="?", default='dataset/embedding/cora/attr_embedding1.txt', help='embedding path')
    ...
    parser.add_argument('--walk_structure_embedding', nargs="?", default='dataset/embedding/cora/walk_struct_embedding.txt', help='walk path')

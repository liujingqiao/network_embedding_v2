...
def parse_args():
    ...
    parser.add_argument('--attr_output', nargs="?", default='dataset/output/wiki/attr_embedding.txt', help='embedding path')
    parser.add_argument('--stru_output', nargs="?", default='dataset/output/wiki/stru_embedding.txt', help='struct path')
    parser.add_argument('--link_output', nargs="?", default='dataset/output/wiki/link_embedding.txt', help='link path')
    parser.add_argument('--walk_output', nargs="?", default='dataset/output/wiki/walk_embedding.txt', help='walk path')
